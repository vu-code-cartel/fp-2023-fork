...
main = hspec $ do
  ...
  describe "Lib3.serializeTable" $ do
    ...
    it "SELECT without WHERE clause to show cartesian product is used" $ do
        db <- setupDB
        res <- runExecuteIO db getCurrentTime $ Lib3.executeSql "SELECT people.id, people.name, people.surname, animals.id, animals.animal FROM people, animals;"
        res `shouldBe` Right (DataFrame [Column "people.id" IntegerType,Column "people.name" StringType,Column "people.surname" StringType,Column "animals.id" IntegerType,Column "animals.animal" StringType] [[IntegerValue 1,StringValue "Vi",StringValue "Po",IntegerValue 1,StringValue "Cat"],[IntegerValue 1,StringValue "Vi",StringValue "Po",IntegerValue 2,StringValue "Dog"],[IntegerValue 2,StringValue "Ja",StringValue "Ne",IntegerValue 1,StringValue "Cat"],[IntegerValue 2,StringValue "Ja",StringValue "Ne",IntegerValue 2,StringValue "Dog"],[IntegerValue 3,StringValue "Jo",StringValue "Nas",IntegerValue 1,StringValue "Cat"],[IntegerValue 3,StringValue "Jo",StringValue "Nas",IntegerValue 2,StringValue "Dog"],[IntegerValue 4,StringValue "Jo",StringValue "Po",IntegerValue 1,StringValue "Cat"],[IntegerValue 4,StringValue "Jo",StringValue "Po",IntegerValue 2,StringValue "Dog"],[IntegerValue 5,StringValue "Ed",StringValue "Dl",IntegerValue 1,StringValue "Cat"],[IntegerValue 5,StringValue "Ed",StringValue "Dl",IntegerValue 2,StringValue "Dog"]])
